...
public class JSONTokener {
	 ...
	 */
	public boolean more() {
		return nextCharIndex < srcString.length();
	}
	 ...
	 */
	public char next() {
		char c = more() ? srcString.charAt(nextCharIndex) : 0;
		nextCharIndex += 1;
		return c;
	}
	...
	public String next(int n) throws ParseException {
		...
		nextCharIndex += n;
		return srcString.substring(i, j);
	}
	...
	public void skipPast(String to) {
		nextCharIndex = srcString.indexOf(to, nextCharIndex);
		if (nextCharIndex < 0) {
			nextCharIndex = srcString.length();
		} else {
			nextCharIndex += to.length();
		}
	}
	...
	public ParseException syntaxError(String message) {
		return new ParseException(message + toString(), nextCharIndex);
	}
	...
	public String toString() {
		return " at character " + nextCharIndex + " of " + srcString;
	}
